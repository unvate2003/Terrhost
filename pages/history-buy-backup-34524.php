                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="table-responsive">
                        <table id="example2" class="table table-bordered table-striped nowrap dataTable">
                            ...
                            <tbody>
                                <?php
                				$result = mysqli_query($conn,"SELECT * FROM `san-pham-da-ban` WHERE `username` = '".$_SESSION['username']."' ORDER BY id DESC ");
                				if($result) {
				                ...
				                <tr>
                                    ...
                                    <td><a href="<?= 'https://'.$_SERVER['HTTP_HOST'] ?>/lich-su-mua.html?code=<?= $row['time']?>"><b><?php echo $query4['subcate']; ?></b></a>
                                    </td>
                                    <td>
                                        <?php echo $row[ 'text']; ?>
                                    </td>
