...
$query_post_title = "SELECT * FROM `subcategories` WHERE key_id = '$key_id_title' "; 
$result_title = mysqli_query($conn, $query_post_title);
$product_title = mysqli_fetch_array($result_title);
                                        ...
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="70%" align="left">
                                                        <?= mysqli_num_rows(mysqli_query($conn,"SELECT * FROM `san-pham-chua-ban` WHERE `subcatekey` = '".$key_id."'")) ?>
                                                    </td>
                                                </tr>
                                                <tr>
