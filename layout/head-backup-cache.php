...
<head>
    ...
    <!-- Font Awesome CSS -->
    <link rel="stylesheet" href="<?php echo 'https://'.$_SERVER['HTTP_HOST'] ?>/assets/themes/font-awesome-4.7.0/css/font-awesome.min.css" type="text/css" />

    <!-- Bootstrap Core CSS  -->
    <link rel="stylesheet" href="<?php echo 'https://'.$_SERVER['HTTP_HOST'] ?>/assets/themes/bootstrap-4.6.1/css/bootstrap.min.css" type="text/css" />

    <!-- Custom styles for this template -->
    <link rel="stylesheet" href="<?php echo 'https://'.$_SERVER['HTTP_HOST'] ?>/assets/themes/css/style.css" type="text/css" />
    <link rel="stylesheet" href="<?php echo 'https://'.$_SERVER['HTTP_HOST'] ?>/assets/themes/css/themes.css" type="text/css" />
    
     <!-- Plugins ionicons -->
    <link rel="stylesheet" href="<?php echo 'https://'.$_SERVER['HTTP_HOST'] ?>/assets/themes/css/ionicons.min.css" type="text/css" />

    <!-- Plugins Sweetalert2 -->
    <link rel="stylesheet" href="<?php echo 'https://'.$_SERVER['HTTP_HOST'] ?>/assets/plugins/sweetalert2/sweetalert2.min.css" type="text/css" />
    
    <!-- Plugins Toastr -->
    <link rel="stylesheet" href="<?php echo 'https://'.$_SERVER['HTTP_HOST'] ?>/assets/plugins/toastr/toastr.min.css" type="text/css" />
    
    <!-- Plugins DataTables -->
    <link rel="stylesheet" href="<?php echo 'https://'.$_SERVER['HTTP_HOST'] ?>/assets/plugins/datatable/dataTables.bootstrap4.min.css" type="text/css" />
    
    <!-- Plugins Sweetalert2 -->
    <script type="text/javascript" src="<?php echo 'https://'.$_SERVER['HTTP_HOST'] ?>/assets/plugins/sweetalert2/sweetalert2.min.js"></script>

    <!-- Plugins Jquery -->
    <script type="text/javascript" src="<?php echo 'https://'.$_SERVER['HTTP_HOST'] ?>/assets/plugins/jquery/jquery-3.6.0.min.js"></script>
</head>
