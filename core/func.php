...
switch ($tinhtrangthe) {
case 0:
$str = '<span class="badge badge-info">Đang xử lý</span>';
break;
case 1:
$str = '<span class="badge badge-success">Hoàn tất</span>';
break;
case 2:
$str = '<span class="badge badge-danger">Thất bại</span>';
break;
default:
$str = '<span class="badge badge-warning">Khác</span>';
break;
}
return $str;
}
...
{
    if (preg_match('/^[a-zA-Z0-9]{5,16}$/', $data, $matches))
    {
        return true;
    }
    else
...
if (!function_exists('chuyenChuoi')) {
    function chuyenChuoi($string)
    {
        $search = array(
